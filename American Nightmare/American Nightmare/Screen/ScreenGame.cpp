...
bool ScreenGame::Start(glm::vec2 screenSize, glm::vec2 screenPosition, State* state, SoundManager* soundManager)
{
	...
	guiManager->AddButton(GUIManager::STARTMENY, glm::vec3(0, -0.25f, 0), glm::vec2(0.4f, 0.15f), materialManager->getMaterial("lightmaterial"));
	guiManager->AddButton(GUIManager::OK, glm::vec3(0, 0.25f, 0), glm::vec2(0.4f, 0.15f), materialManager->getMaterial("lightmaterial"));
	guiManager->AddButton(GUIManager::EXIT, glm::vec3(0, -0.75f, 0), glm::vec2(0.4f, 0.15f), materialManager->getMaterial("lightmaterial"));
...
void ScreenGame::SetStartVariables()
{
	...
	levelManager->LoadLevel(shaderManager->getShader("deferred"), LEVEL_PATH "lvl.anl");
