...
bool ScreenGame::Start(glm::vec2 screenSize, glm::vec2 screenPosition, State* state, SoundManager* soundManager)
{
	...
	materialManager->AddMaterial("postermaterial_2", glm::vec3(1.f), glm::vec3(1.f), glm::vec3(1.f), 1.f, "poster_2", POSTER_PATH "poster_2.jpg");
	...
	if (materialManager->getMaterial("postermaterial_2") == nullptr) printf("Poster Material not found\n");
